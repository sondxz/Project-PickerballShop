...
<html lang="en">
  <head>
    ...
    <title>${product.name} - PickleballShop</title>
    <!-- Google Web Fonts -->
          ...
          <div class="col-lg-8 col-xl-9">
            <div class="row g-4">
              ...
              <div class="col-lg-6">
                ...
                <p class="mb-3">Danh mục: Vợt ${product.factory}</p>
                ...
                <form
                  action="/add-product-form-view-detail"
                  method="post"
                ...
                >
                  ...
                  <input
                    ...
                    type="text"
                    name="quantity"
                    id="cartDetailQuantity0.quantity"
                  />
            ...
            <c:forEach var="relatedProduct" items="${relatedProducts}">
              ...
              >
                <div class="vesitable-img">
                  <img
                    src="/images/products/${relatedProduct.image}"
                ...
                <div class="p-4 pb-0 rounded-bottom">
                  <h4 style="font-size: 16px">${relatedProduct.name}</h4>
                  ...
                  <div class="d-flex justify-content-between flex-lg-wrap">
                    ...
                    <a
                      ...
                      ><i class="fa fa-eye me-2 text-primary"></i> Xem chi
                      tiết</a
                    >
                  </div>
                </div>
